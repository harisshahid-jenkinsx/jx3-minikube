...
<table class="table">
  ...
  <tbody>
    <tr>
		      <td colspan='4'><h3>dnd-jenkins</h3></td>
		    </tr>
	    <tr>
	      <td><a href='https://jenkins.io/' title='Jenkins - Build great things at any scale! The leading open source automation server, Jenkins provides hundreds of plugins to support building, deploying and automating any project.'> <img src='https://get.jenkins.io/art/jenkins-logo/logo.svg' width='24px' height='24px'> jenkins </a></td>
	      <td></td>
	      <td></td>
